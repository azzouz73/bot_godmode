...
def web():
    ...
    <div class="card">📦 Cycle actif: {cycle_active}</div>
...
def open_position(symbol, side, usd, lev):
    try:
        ...
        send(f"🚀 {symbol} {side} | {round(usd,2)}$ | lev {lev}")
        return True
